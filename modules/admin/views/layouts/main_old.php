...
//            echo "current_route=$current_route <br />";
            ...
            <ul class="sidebar-menu">
                <?php if(in_array(Yii::$app->session->get('role_alias'), ['root', 'admin'])) { ?>
                    <li class="treeview <?= ($current_module == 'admin' && (in_array($current_controller, ['city', 'direction', 'tariff', 'cashback-setting', 'trip-operation'])) || $current_route == 'admin/setting/vrpt') ? 'active' : '' ?>">
                        <a href="#">
                ...
                <?php if(in_array(Yii::$app->session->get('role_alias'), ['root', 'admin', 'editor'])) { ?>
                    <li class="treeview <?= ($current_module == 'admin' && in_array($current_controller, ['transport'])) ? 'active' : '' ?>">
                        <a href="#">
                ...
                <?php if(in_array(Yii::$app->session->get('role_alias'), ['root', 'admin', 'editor', 'graph_operator'])) { ?>
                    <li class="treeview <?= ($current_module == 'admin' && in_array($current_controller, ['driver', 'driver-accounting', 'magic-device-code', 'driver-photo'])) ? 'active' : '' ?>">
                        <a href="#">
                            <i class="fa fa-truck"></i> <span>Водители</span>
                            <span class="pull-right-container">
                              <i class="fa fa-angle-left pull-right"></i>
                            </span>
                        </a>
                ...
                <?php if(in_array(Yii::$app->session->get('role_alias'), ['root', 'admin'])) { ?>
                    <li class="treeview <?= (in_array($current_controller, ['operator', 'operator-accounting', 'operator-subscription', 'call-case', 'working-shift']) || ($current_route == 'admin/call/index')) ? 'active' : '' ?>">
                        <a href="#">
                ...
                <?php if(in_array(Yii::$app->session->get('role_alias'), ['root', 'admin'])) { ?>
                    ...
                    <li class="treeview <?= ($current_module == 'admin' && $current_controller=='informer-office' ? 'active' : '') ?>">
                        <a href="#">
                        ...
                        <ul class="treeview-menu">
                            <li<?= $current_controller == 'informer-office' && $current_route == 'admin/informer-office/index' ? ' class="active"' : '' ?>>
                                <?= Html::a('<i class="fa fa-meh-o"></i> <span>Источники</span>', '/admin/informer-office'); ?>
                            </li>
                            <li<?= $current_controller == 'informer-office' && $current_route == 'admin/informer-office/report' ? ' class="active"' : '' ?>>
                                <?= Html::a('<i class="fa fa-tasks"></i> <span>Активность источников</span>', '/admin/informer-office/report'); ?>
                            </li>
                        </ul>
                    </li>
                ...
                <?php if(in_array(Yii::$app->session->get('role_alias'), ['root', 'admin'])) { ?>
                    ...
                    <li class="treeview <?= ($current_module == 'admin' && in_array($current_controller, ['advertising-source', 'advertising-source-report']) ? 'active' : '') ?>">
                        <a href="#">
                            <i class="glyphicon glyphicon-fire"></i> <span>Рекламные источники</span>
                            <span class="pull-right-container">
                              <i class="fa fa-angle-left pull-right"></i>
                            </span>
                        </a>
                        <ul class="treeview-menu">
                            ...
                            <li<?= $current_controller == 'advertising-source-report' ? ' class="active"' : '' ?>>
                                <?= Html::a('<i class="fa fa-tasks"></i> <span>Отчет о рекламных источниках</span>', '/admin/advertising-source-report'); ?>
                            </li>
                        </ul>
                    </li>
                ...
                <?php } ?>
                <?php if(in_array(Yii::$app->session->get('role_alias'), ['root', 'admin'])) { ?>
                    <li<?= ($current_module == 'admin' && in_array($current_controller, ['formula', 'day-report-transport-circle', 'do-tariff']) ? ' class="active"' : '') ?>>
                        <a href="#">
                ...
                <?php
                if(in_array(Yii::$app->session->get('role_alias'), ['root', 'admin'])) { ?>
                    <li<?= ($current_module == 'admin' && (in_array($current_route, ['admin/setting/create-orders-yesterday', 'admin/rescue/actions', 'admin/setting/display', 'admin/setting/photo-server-url', 'admin/setting/another']) || in_array($current_controller, ['socket-ip',])) ? ' class="active"' : '') ?>>
                        <a href="#">
