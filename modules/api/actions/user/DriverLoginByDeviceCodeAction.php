...
use Yii;
use app\models\DriverLoginByDeviceCodeForm;



class DriverLoginByDeviceCodeAction extends \yii\rest\Action
{
    public $modelClass = '';
    ...
    public function run()
    {
        $driverLoginForm = new DriverLoginByDeviceCodeForm();
        ...
        return [
            ...
            'transport_access_key' => $trip_transport->access_key, // возвращаем обратно, потому в приложение нужно сохранять правильный (правильно заполненный) идентификатор машины
