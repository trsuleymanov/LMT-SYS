...
//    //throw new \yii\web\ForbiddenHttpException('Это консольный запуск, значит нельзя определить пользователя по отсутствующей сессии');
//    $user_role_alias = [];
//}else {
...
/*
if($client == null) { ?>
    <div class="call-form-text"><b>Клиент<b> <red>Новый клиент<red> Вероятность отказа: NA</div>
<?php }else { ?>
    <div class="call-form-text"><b>Клиент</b> <?= $client->name ?>:&nbsp;&nbsp;&nbsp;&nbsp;Вероятность отказа: 100/100-30/40</div>
<?php }*/ ?>
...
echo \Yii::$app->view->renderAjax('@app/views/call/_grid.php', [
    'client' => $client,
